...
{% highlight cpp %}
std::vector<std::enable_if_t<std::is_integral<cost_type>::value, cost_type> > bfs01(const graph_t< edge_t > &g, int s);
{% endhighlight %}
...
std::vector<std::enable_if_t<std::is_integral<cost_type>::value, cost_type>>
