...
int main() {
  ...
  cout << endl << "=== STL ===" << endl;
  array_testsuite.run(test_sort,           10043273327132148061ULL);
  array_testsuite.run(test_priority_queue,  9927045758423964030ULL);
  array_testsuite.run(test_set,            15108157720665341275ULL);
